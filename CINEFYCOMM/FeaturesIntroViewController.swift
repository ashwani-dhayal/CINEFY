...
class FeaturesIntroViewController: UIViewController {
    ...
    private let logoStackView: UIStackView = {
        ...
        stack.spacing = -2 // Tighter spacing between C and inefy
    ...
    private let logoLabel: UILabel = {
        let label = UILabel()
        label.text = "inefy."
        label.font = .systemFont(ofSize: 52, weight: .bold) // Increased font size
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            // Logo stack view - centered horizontally and vertically positioned
            logoStackView.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            logoStackView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 80), // Adjusted for better spacing
            
            // Feature stack view
            stackView.topAnchor.constraint(equalTo: logoStackView.bottomAnchor, constant: 100), // Increased spacing
